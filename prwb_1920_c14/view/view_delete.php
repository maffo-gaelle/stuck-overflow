...
<html>
    <head>
        <meta charset="UTF-8">
        <title>suppression du post <?php echo $post->PostId; ?></title>
        <base href="<?= $web_root ?>"/>
    ...
    <body>
        ...
        <div class="jumbotron" style = "">
            <form action = "post/delete/<?php echo $post->PostId; ?>" method = "post" style = "text-align: center; margin-left: 25%;">
                <div class="card border-primary mb-3" style="max-width: 40rem;  padding: 10px;">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">êtes vous sûre de vouloir supprimer ce post?</h4>
